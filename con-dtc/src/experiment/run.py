    ...
    with log_path.open("w", encoding="utf-8") as log_file:
        ...
        try:
            ...
            model, history, checkpoint_path = train_condtc(
                ...
                history_instance_loss_weight=config.loss.history_instance_loss_weight,
                history_instance_temperature=config.loss.history_instance_temperature,
                history_instance_start_epoch=config.loss.history_instance_start_epoch,
                history_encoder_ema_momentum=config.loss.history_encoder_ema_momentum,
