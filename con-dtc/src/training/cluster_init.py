...
class CrossViewSoftTargetEMA:
    def __init__(
        ...
        self.weighting_signal = weighting_signal
        self.ema_q1 = None
        self.ema_q2 = None
    ...
    def update(self, q1, q2):
        ...
        if self.ema_q1 is None:
            ...
            reliability_output = compute_reliability_weight(
                ...
                weighting_signal=self.weighting_signal
            )
...
def compute_reliability_weight(
    ...
    if weighting_signal == "stability":
        reliability = relative_stability
    elif weighting_signal == "margin":
        reliability = margin_confidence
    elif weighting_signal == "stability_margin":
        reliability = relative_stability * margin_confidence
    else:
        raise ValueError(f"unknown weighting_signal: {weighting_signal}")
